...
- [jketterl/openwebrx](https://github.com/jketterl/openwebrx) - Open source, multi-user SDR receiver software with a web interface (2 days ago)
- [HariSekhon/Packer-templates](https://github.com/HariSekhon/Packer-templates) - HashiCorp Packer templates to build portable virtual machines in OVA format for Ubuntu, Debian and Redhat based systems with automated installers Kickstart, Preseed and AutoInstaller / Cloud-Init. Useful for IoT edge sites, Kubernetes base systems and VM appliances to ship to customers (6 days ago)
- [uroesch/packer-linux](https://github.com/uroesch/packer-linux) - Framework to create linux disk images for a corporate environment. (6 days ago)

...
- [Add UEFI Secure Boot support](https://github.com/netbootxyz/docker-netbootxyz/pull/134) on [netbootxyz/docker-netbootxyz](https://github.com/netbootxyz/docker-netbootxyz) (5 days ago)
- [Publish autoexec.ipxe as standalone release asset for Secure Boot](https://github.com/netbootxyz/netboot.xyz/pull/1759) on [netbootxyz/netboot.xyz](https://github.com/netbootxyz/netboot.xyz) (5 days ago)
- [Fix ESM parse error for isbinaryfile mock in tests](https://github.com/netbootxyz/webapp/pull/133) on [netbootxyz/webapp](https://github.com/netbootxyz/webapp) (5 days ago)
- [Fix test suite crashes from nock v14 and ESM incompatibility](https://github.com/netbootxyz/webapp/pull/132) on [netbootxyz/webapp](https://github.com/netbootxyz/webapp) (5 days ago)
- [Fix unhandled nock/mswjs error crashing test process](https://github.com/netbootxyz/webapp/pull/131) on [netbootxyz/webapp](https://github.com/netbootxyz/webapp) (5 days ago)
